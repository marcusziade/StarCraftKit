...
public struct TournamentsResponse: Codable {
    public let tournaments: [Tournament]
    public init(tournaments: [Tournament]) {
    ...
    public var ongoingTournaments: [Tournament] {
    ...
    public var upcomingTournaments: [Tournament] {
        let currentDate = Date()
        return tournaments.filter { tournament in
            let beginDate = tournament.beginAt
    ...
    public var concludedTournaments: [Tournament] {
    ...
    public var tournamentsByTier: [String: [Tournament]] {
    ...
    public func tournamentById(id: Int) -> Tournament? {
    ...
    public func tournamentsWithPrizepool(_ prizepool: String) -> [Tournament] {
    ...
    public var totalTournaments: Int {
        tournaments.count
    }
    ...
    public var tournamentsByStartDate: [Tournament] {
    ...
    public var liveSupportedTournaments: [Tournament] {
