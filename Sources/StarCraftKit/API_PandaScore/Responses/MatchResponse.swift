...
public struct MatchResponse: Codable {
    ...
    public var ongoingMatches: [Match] {
        matches.filter { match in
    ...
    public var completedMatches: [Match] {
        matches.filter { match in
    ...
    public func matchesBy(playerId: Int) -> [Match] {
        matches.filter { match in
    ...
    public var averageMatchDuration: Double {
    ...
    public var matchesByLeague: [Int: [Match]] {
    ...
    public var matchesByTournament: [Int: [Match]] {
    ...
    public func winRateByPlayer(playerId: Int) -> Double {
    ...
    public var mostCommonMatchup: (player1Id: Int, player2Id: Int, count: Int)? {
    ...
    public var matchesWithDetailedStats: [Match] {
